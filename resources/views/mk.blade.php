...
<body class="bg-blue-50 p-6">
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-4">
        <h1 class="text-center text-xl font-bold mb-4">Laman Mata Kuliah</h1>
                ...
                <tbody>
                  @foreach ($data['mk'] as $item)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        @if (Session::get('userRights')->contains('editKurikulum'))
                  ...
                  {{-- Row Input Data --}}
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    <form action="{{ route('mk.store') }}" method="POST" id="form-data">
                        @csrf
